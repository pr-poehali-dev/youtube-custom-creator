...
import { Search, Bell, Upload, Menu, User } from "lucide-react";
      ...
      <div className="flex items-center justify-between h-full px-4">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-1">
            <svg height="24" viewBox="0 0 90 20" fill="currentColor" className="text-red-600">
        ...
        <div className="hidden md:flex items-center flex-1 max-w-xl mx-8">
          <div className="relative flex-1">
            <Input 
              placeholder="Поиск" 
              className="pl-4 pr-10 py-2 w-full bg-accent/50 border-accent-foreground/20 focus-visible:ring-primary"
            />
